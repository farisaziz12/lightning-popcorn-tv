    ...
    _createClass(TextTextureRendererAdvanced, [{
      ...
      value: function _calculateRenderInfo() {
        ...
        if (renderInfo.maxLines && renderInfo.lineNum > renderInfo.maxLines && renderInfo.maxLinesSuffix) {
          ...
          _suffix = this.measure(_suffix, renderInfo.letterSpacing)[0];
    ...
    _createClass(TextTexture, [{
      ...
      value: function _getSourceLoader() {
        ...
        return function (cb) {
          ...
          var p = renderer.draw();
          var texParams = {};
          var sharpen = this.stage.getRenderPrecision() < this.stage.getOption('textRenderSharpPrecision') && args.fontSize < this.stage.getOption('textRenderSharpFontSize');
    ...
    _createClass(Application, [{
      ...
      value: function _withinClickableRange(affectedChildren, cursorX, cursorY) {
        ...
        var _loop = function _loop() {
          ...
          var precision = _this6.stage.getRenderPrecision();
          ...
          if (cx > _this6.stage.w || cy > _this6.stage.h) {
            return "continue";
          }
          ...
          if (child.parent.core._scissor) {
            ...
            if (!_this6._testCollision.apply(_this6, [cursorX, cursorY].concat(_toConsumableArray(scissor)))) return "continue";
          }

          if (_this6._testCollision(cursorX, cursorY, cx, cy, cw, ch)) {
